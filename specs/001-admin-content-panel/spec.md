...
- **FR-006**: O casal MUST poder criar, editar, reordenar e remover itens da lista de presentes. Campos de um presente: título (obrigatório), descrição (obrigatória), Pix copia e cola (opcional, mas exigido para mostrar pagamento), imagem (opcional), valor sugerido (opcional, já usado na experiência pública atual).
